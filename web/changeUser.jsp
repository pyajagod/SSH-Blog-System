...
<body>
    <div class="layui-anim layui-anim-up layui-anim-rotate">
        <div class="rg_layout">
            ...
            <div class="rg_center">
                <form class="layui-form layui-form-pane" action="changeInfoAction.action" method="post">

                    <div class="layui-form-item">
                        <label class="layui-form-label">账号</label>
                        <div class="layui-input-inline">
                            <input type="text" value="${sessionScope.user.userId}" name="userid" hidden />
                            <input type="text" id="userId" value="${sessionScope.user.userId}" name="user.userId" lay-verify="required" placeholder="请输入账号" autocomplete="off" class="layui-input" onblur="checkUseId()">
                            <input type="text" value="${sessionScope.user.id}" hidden name="user.id" />
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="user.userName" value="${sessionScope.user.userName}" lay-verify="required" placeholder="请输入用户名" autocomplete="off" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <button class="layui-btn" lay-submit="" lay-filter="demo1" onblur="checkAll()">立即修改</button>
            ...
            <div class="rg_right">
                <p>放弃修改？<a href="index.jsp">返回</a></p>
            </div>
        </div>
    </div>
