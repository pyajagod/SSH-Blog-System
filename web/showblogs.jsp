...
<%--                        <button  >阅读全文</button>--%>
    ...
    <c:forEach items="${ids}" var="id">
        ...
        <div style=" font-size: 20px;">
            ...
            <c:if test="${curPage > 1}">
                <a href="selectArticleAction.action">首页</a>
                <a href="selectArticleAction.action?curPage=${curPage - 1}">上一页</a>
            </c:if>
            ...
            <c:if test="${curPage < totalPages}">
                <a href="selectArticleAction.action?curPage=${curPage + 1}">下一页</a>
                <a href="selectArticleAction.action?curPage=${totalPages}">尾页</a>
            </c:if>
        </div>
